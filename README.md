...
GitHub
📂 Project Structure
FlightFinder/ │── client/ │── server/ │── README.md

🛠 Architecture Overview

Frontend: React.js (UI for Search, Login, Booking) Backend: Node.js + Express.js (REST APIs) Database: MongoDB Communication: Axios (API Calls)
